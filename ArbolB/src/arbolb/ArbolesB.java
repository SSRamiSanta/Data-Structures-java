...
public class ArbolesB extends JFrame implements ActionListener {
    ...
    public ArbolesB() throws BadLocationException {
        ...
        //insertar(ParbB);
        ParbB = new ProcesosArbolesB(2);
        System.out.println(ParbB.getOrdenarbol());
...
//            System.out.println("Recorrido: "+ParbB.imprimirarbol(ParbB));  
            buscar();
    ...
    public void eliminar() {
        ...
        txtBuscarEliminar.setText("");
//        int valor = Integer.parseInt(strValor);
        String del = ParbB.eliminar(strValor);
        txtBuscarEliminar.requestFocus();
...
//        }
    ...
    public void buscar() {
        ...
        txtBuscarEliminar.setText("");
//        int valor = Integer.parseInt(strValor);
        Nodo nd = ParbB.buscar(strValor);
        if (nd != null) {
            JOptionPane.showConfirmDialog(null, "El número " + strValor + " se encuentra en el nivel: " + nd.getNivel());
        } else {
